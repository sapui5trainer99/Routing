		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing",
									"targetURL": "#routingrouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"routingrouting-display": {
								"semanticObject": "routingrouting",
								"action": "display",
								"description": "Routing",
								"title": "Routing",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=routing.routing",
									"url": sap.ui.require.toUrl("routing/routing")
								}
							}
						}
					}
